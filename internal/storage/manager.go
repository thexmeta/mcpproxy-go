...
func (m *Manager) SaveUpstreamServer(serverConfig *config.ServerConfig) error {
	...
	record := &UpstreamRecord{
		...
		SkipQuarantine:       serverConfig.SkipQuarantine,
		Shared:               serverConfig.Shared,
		...
		ExcludeDisabledTools: serverConfig.ExcludeDisabledTools,
	}
...
func (m *Manager) GetUpstreamServer(name string) (*config.ServerConfig, error) {
	...
	return &config.ServerConfig{
		...
		SkipQuarantine:       record.SkipQuarantine,
		...
		ExcludeDisabledTools: record.ExcludeDisabledTools,
	}, nil
}
