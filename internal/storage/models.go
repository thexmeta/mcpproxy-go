...
type UpstreamRecord struct {
	...
	DisabledTools        []string                `json:"disabled_tools,omitempty"`   // Tools disabled for this server
	ExcludeDisabledTools bool                    `json:"exclude_disabled_tools,omitempty"` // If true, exclude disabled tools from listings
}
